function doubanBookCard(bookID) {
  ...
  fetch(url, { method: "get" })
    ...
    .then((data) => {
      ...
      document.querySelector("#douban-card-book-" + bookID).innerHTML =
        ...
        '<span class="douban-card--stars douban-card--stars-' +
        stars +
        '"></span>' +
        '<span class="douban-card--rating">' +
        rating +
        "</span>" +
        "</div>" +
        '<div class="douban-card--tags">' +
        tags.join(" / ") +
        "</div>" +
        '<div class="douban-card--summary">' +
        intro +
        "</div>" +
        "</div>" +
...
function doubanMovieCard(movidID) {
  ...
  fetch(url, { method: "get" })
    ...
    .then((data) => {
      ...
      document.querySelector("#douban-card-movie-" + movidID).innerHTML =
        '<div class="douban-card--middle">' +
        '<div class="douban-card--title">' +
