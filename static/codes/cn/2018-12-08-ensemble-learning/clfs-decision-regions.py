...
clf_meta_lr = LogisticRegression(
...
clf_mlp = MLPClassifier(
    hidden_layer_sizes=(4, 4), activation='logistic', solver='lbfgs', random_state=1
)
...
clf_vot = EnsembleVoteClassifier(
    clfs=[clf_lr, clf_dt, clf_knn, clf_svc, clf_nb, clf_mlp, clf_rf], voting='soft'
)
...
clfs = [clf_lr, clf_dt, clf_knn, clf_svc, clf_nb, clf_mlp, clf_rf, clf_vot, clf_stk]
