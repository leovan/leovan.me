...
arrow(
    0, 0, 1, 2, head_width=0.1, length_includes_head=True, fc='b', ec='b', overhang=0.3
)
arrow(
    0, 0, 2, 1, head_width=0.1, length_includes_head=True, fc='b', ec='b', overhang=0.3
)
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-inner-product-and-projection.png',
    dpi=dpi,
)
...
arrow(
    0, 0, 3, 2, head_width=0.1, length_includes_head=True, fc='b', ec='b', overhang=0.3
)
plot([0, 3], [2, 2], color='g', linestyle='--')
plot([3, 3], [0, 2], color='g', linestyle='--')
arrow(
    0, 0, 0, 1, head_width=0.1, length_includes_head=True, fc='r', ec='r', overhang=0.3
)
arrow(
    0, 0, 1, 0, head_width=0.1, length_includes_head=True, fc='r', ec='r', overhang=0.3
)
plot([3], [2], 'o', color='k')
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-change-of-bases.png',
    dpi=dpi,
)
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-linear-transformation-1.png',
    dpi=dpi,
)
# %%
dpi = 100
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-linear-transformation-2.png',
    dpi=dpi,
)
# %%
dpi = 100
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-linear-transformation-3.png',
    dpi=dpi,
)
# %%
dpi = 100
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-linear-transformation-4.png',
    dpi=dpi,
)
# %%
dpi = 100
...
savefig(
    '../../static/images/cn/2017-12-11-evd-svd-and-pca/vector-linear-transformation-5.png',
    dpi=dpi,
)
