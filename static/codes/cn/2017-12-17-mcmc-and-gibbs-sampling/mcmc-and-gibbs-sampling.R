...
ggsave("../../static/images/cn/2017-12-17-mcmc-and-gibbs-sampling/mc-pi.png", p,
  device = "png",
...
ggsave("../../static/images/cn/2017-12-17-mcmc-and-gibbs-sampling/mc-pi-simulation.png", p,
  device = "png",
  width = 6, height = 6, units = "cm",
  dpi = 150, scale = 1
)
...
frame_plot <- function(samples) {
  ...
  width_max <- unit.pmax(
    p_samples_$widths[2:3],
    p_density_x_$widths[2:3]
  )
  height_max <- unit.pmax(
    p_samples_$heights[7:8],
