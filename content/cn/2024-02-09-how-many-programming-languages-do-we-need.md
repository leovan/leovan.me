...
{{% admonition type="tip" %}}
人生苦短，我用 <i class="icon icon-python"></i> Python。  
想要甜些，得上 <i class="icon icon-javascript"></i> JavaScript / <i class="icon icon-typescript"></i> TypeScript。  
开心的话，就用 <i class="icon icon-r"></i> R。  
再想更屌，恶补 <i class="icon icon-rust"></i> Rust。
{{% /admonition %}}
