...
> 文章部分内容参考了 Christopher 的博客 [Understanding LSTM Networks](http://colah.github.io/posts/2015-08-Understanding-LSTMs/)，内容翻译和图片重绘已得到原作者同意，重绘后的图片源文件请参见 [这里](https://github.com/leovan/statics.leovan.me/tree/master/images/cn/2018-09-21-rnn/)。
