...
<h2 class="center no-anchor"> 「读书，不是非做不可的事，而是想要去做的事。」</h2>
...
book_table <- function(books) {
    ...
    header_ <- paste0('<h2 class="center no-anchor">', which_year, "</h2>")
    table_ <- books |>
...
book_list_auto_update <- book_list_auto_update |>
    mutate(douban_info = get_book_douban_info(douban_id)) |>
