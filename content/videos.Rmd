...
<h2 class="center no-anchor">「共鸣，情愫，观念，认知，体验，情怀」</h2>
...
video_table <- function(videos) {
    which_year <- gen_which_year(videos[1, ]$release_date)
...
video_list |>
    mutate(
        directors = split_top_n_concat(directors, ", ", 1),
        actors = split_top_n_concat(actors, ", ", 3),
...
video_list_auto_update <- video_list_auto_update |>
    ...
    mutate(douban_info = get_video_douban_info(douban_id, is_tv)) |>
